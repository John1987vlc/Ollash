...
from .metrics_bp import metrics_bp, init_app as init_metrics
from .monitors_bp import monitors_bp, init_app as init_monitors
from .triggers_bp import triggers_bp, init_app as init_triggers
...
from .learning_bp import learning_bp, init_app as init_learning
from .refinement_bp import refinement_bp, init_refinement
from .multimodal_bp import multimodal_bp, init_app as init_multimodal
...
def register_blueprints(
    ...
    blueprints = [
        ...
        (auto_agent_bp, lambda: init_auto_agent(ollash_root_dir, event_publisher, chat_event_bridge)),
        ...
        (alerts_bp, lambda: init_alerts(ollash_root_dir, event_publisher, alert_manager)),
        (automations_api_bp, lambda: init_automations_api(ollash_root_dir, event_publisher)),
    ...
    for bp, init_func in blueprints:
        try:
            ...
            logger.error(f"Failed to initialize or register blueprint '{bp.name}': {e}", exc_info=True)
