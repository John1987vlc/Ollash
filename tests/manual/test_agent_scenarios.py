...
SCENARIOS = [
    # --- CATEGORÍA 1: System & Sandbox (20) ---
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "¿Qué sistema operativo tengo y cuánta RAM hay libre?", "expected_tools": ["get_system_info"]}]
    },
    {
        "name": "list_heavy_processes",
        "setup_files": {},
        "steps": [{"instruction": "Dime qué procesos están consumiendo más recursos ahora mismo", "expected_tools": ["list_processes"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Avísame si la RAM libre baja del 10%", "expected_tools": ["check_resource_threshold"]}]
    },
    {
        "name": "init_sandbox_env",
        "setup_files": {},
        "steps": [{"instruction": "Prepara un entorno de scripting aislado", "expected_tools": ["init_scripting_environment"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Limpia el entorno de ejecución temporal", "expected_tools": ["cleanup_environment"]}]
    },
    {
        "name": "monitor_disk_health",
        "setup_files": {},
        "steps": [{"instruction": "¿Cómo está el estado de salud de mis discos?", "expected_tools": ["run_shell_command"]}]
    },
    {
        "name": "analyze_startup",
        "setup_files": {},
        "steps": [{"instruction": "Analiza qué servicios se inician con el sistema", "expected_tools": ["run_shell_command"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Busca archivos de más de 100MB en la raíz", "expected_tools": ["run_shell_command"]}]
    },
    {
        "name": "get_cpu_temp",
        "setup_files": {},
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "¿Hay mucha espera de entrada/salida en el disco?", "expected_tools": ["run_shell_command"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Crea un archivo src/utils.py con una función de suma", "expected_tools": ["write_file"]}]
    },
    {
    ...
    },
    {
        ...
        "steps": [{"instruction": "Borra el archivo de configuración temporal config/temp.json", "expected_tools": ["delete_file"]}]
    },
    {
        "name": "diff_configs",
    ...
    },
    {
        ...
        "steps": [{"instruction": "Busca funciones con demasiada complejidad en src/math.py", "expected_tools": ["analyze_project"]}]
    },
    {
        "name": "suggest_api_refactor",
        "setup_files": {"src/api.py": "def get_data(): return 1"},
        "steps": [{"instruction": "¿Cómo podría mejorar la estructura de src/api.py?", "expected_tools": ["read_file"]}]
    },
    {
        "name": "map_imports",
    ...
    },
    {
        ...
        "setup_files": {"src/app.py": "def run(): pass"},
        "steps": [{"instruction": "Verifica si las funciones de src/app.py tienen docstrings", "expected_tools": ["read_file"]}]
    },
    {
    ...
    },
    {
        ...
        "steps": [{"instruction": "Cambia USER_ID por GLOBAL_USER_ID en src/core.py", "expected_tools": ["write_file"]}]
    },
    {
        "name": "count_lines_of_code",
        "setup_files": {"src/main.py": "print(1)\nprint(2)"},
        "steps": [{"instruction": "¿Cuántas líneas de código tiene src/main.py?", "expected_tools": ["run_shell_command"]}]
    },
    {
        "name": "extract_interface",
        "setup_files": {"src/service.py": "class Service: def call(self): pass"},
        "steps": [{"instruction": "Extrae una interfaz para la clase Service en src/service.py", "expected_tools": ["read_file"]}]
    },
    {
    ...
    },
    {
        ...
        "steps": [{"instruction": "Haz un commit de los cambios actuales con el mensaje 'feat: add new module'", "expected_tools": ["run_shell_command"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "¿Qué diferencias hay en los archivos preparados para commit?", "expected_tools": ["run_shell_command"]}]
    },
    {
        "name": "git_create_branch",
        "setup_files": {},
        "steps": [{"instruction": "Crea una nueva rama llamada 'fix/bug-123'", "expected_tools": ["run_shell_command"]}]
    },
    {
    ...
    },
    {
        "name": "git_stash_pop",
        "setup_files": {},
        "steps": [{"instruction": "Recupera los cambios guardados en el stash", "expected_tools": ["run_shell_command"]}]
    },
    {
        "name": "git_show_remote",
        "setup_files": {},
        "steps": [{"instruction": "¿Cuál es la URL de mi repositorio remoto?", "expected_tools": ["run_shell_command"]}]
    },
    {
        "name": "git_blame_file",
        "setup_files": {"src/main.py": "line 1"},
        "steps": [{"instruction": "¿Quién escribió la línea 1 de src/main.py?", "expected_tools": ["run_shell_command"]}]
    },
    {
    ...
    },
    {
        ...
        "steps": [{"instruction": "¿Está el archivo app.log ignorado por git?", "expected_tools": ["run_shell_command"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Inicia un rebase interactivo de los últimos 3 commits", "expected_tools": ["run_shell_command"]}]
    },
    {
        "name": "git_clean_untracked",
        "setup_files": {},
        "steps": [{"instruction": "Borra todos los archivos no seguidos por git", "expected_tools": ["run_shell_command"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Muéstrame las conexiones de red activas", "expected_tools": ["list_active_connections"]}]
    },
    {
        "name": "audit_secrets_in_src",
        "setup_files": {"src/config.py": "KEY = '12345'"},
        "steps": [{"instruction": "Busca secretos o claves API expuestas en el código", "expected_tools": ["search_code"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Haz un ping a google.com para ver si tengo internet", "expected_tools": ["ping_host"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "¿Cuándo caduca el certificado SSL de este sitio?", "expected_tools": ["run_shell_command"]}]
    },
    {
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Audita procesos sospechosos que puedan ser backdoors", "expected_tools": ["list_processes"]}]
    },
    {
        "name": "check_ssh_auth_logs",
        "setup_files": {"logs/auth.log": "Failed password for root"},
        "steps": [{"instruction": "Busca intentos de acceso fallidos por SSH en logs/auth.log", "expected_tools": ["analyze_security_log"]}]
    },
    {
        "name": "recommend_hardening",
        "setup_files": {"config/sysctl.conf": "net.ipv4.ip_forward = 1"},
        "steps": [{"instruction": "Sugiere mejoras de seguridad para la configuración del sistema", "expected_tools": ["recommend_security_hardening"]}]
    },
    {
        "name": "calculate_network_mask",
        "setup_files": {},
        "steps": [{"instruction": "Calcula la máscara de subred para 192.168.1.0/24", "expected_tools": ["calculate_subnets"]}]
    },
    {
        "name": "nmap_advanced_scan",
        "setup_files": {},
        "steps": [{"instruction": "Haz un escaneo nmap agresivo a la red local", "expected_tools": ["advanced_nmap_scan"]}]
    },
    {
        "name": "check_dns_poisoning",
        "setup_files": {"/etc/hosts": "1.1.1.1 google.com"},
        "steps": [{"instruction": "Verifica si el archivo hosts tiene entradas sospechosas", "expected_tools": ["read_file"]}]
    },
    {
        "name": "audit_cisco_file",
        "setup_files": {"switch.cfg": "interface FastEthernet0/1"},
        "steps": [{"instruction": "Audita la configuración de este switch Cisco", "expected_tools": ["audit_cisco_config"]}]
    },
    {
        "name": "scapy_packet_inject",
        "setup_files": {},
        "steps": [{"instruction": "Simula una inyección de paquetes ICMP usando Scapy", "expected_tools": ["run_scapy_simulation"]}]
    },
    {
        "name": "check_proxy_config",
        "setup_files": {},
        "steps": [{"instruction": "¿Tengo algún proxy configurado en las variables de entorno?", "expected_tools": ["run_shell_command"]}]
    },
    {
        "name": "verify_file_permissions",
        "setup_files": {"src/secrets.py": "key=1"},
        "steps": [{"instruction": "¿Tiene src/secrets.py permisos de lectura para todo el mundo?", "expected_tools": ["run_shell_command"]}]
    },
    ...
    # --- CATEGORÍA 5: Planning & Command Line (20) ---
    {
        "name": "plan_full_app",
        "setup_files": {},
        "steps": [{"instruction": "Planifica la creación de una app de notas con Flask y SQLite", "expected_tools": ["plan_actions"]}]
    },
    {
        "name": "run_ls_cmd",
        "setup_files": {},
    ...
    },
    {
        ...
        "setup_files": {},
        "steps": [{"instruction": "Lanza un escaneo de puertos pesado en segundo plano", "expected_tools": ["run_async_tool"]}]
    },
    {
        "name": "check_job_status",
        "setup_files": {},
        "steps": [{"instruction": "¿Cómo va la tarea asíncrona con ID 'job_123'?", "expected_tools": ["check_async_task_status"]}]
    },
    {
        "name": "switch_to_code_specialist",
        "setup_files": {},
        "steps": [{"instruction": "Cambia al modo especialista de código para seguir", "expected_tools": ["select_agent_type"]}]
    },
    {
    ...
    },
    {
        "name": "plan_migration",
        "setup_files": {},
        "steps": [{"instruction": "Planifica la migración de la base de datos de v1 a v2", "expected_tools": ["plan_actions"]}]
    },
    {
    ...
    },
    {
        "name": "backup_project",
        "setup_files": {},
        "steps": [{"instruction": "Crea un archivo comprimido .zip con todo el proyecto", "expected_tools": ["run_command"]}]
    },
    {
