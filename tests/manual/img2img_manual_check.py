...
from backend.utils.domains.multimedia.image_generation_tools import ImageGeneratorTools  # noqa: E402
...
initial_result = image_gen.generate_image(prompt="a beautiful red car", steps=5, filename="input_car")
