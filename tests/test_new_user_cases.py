...
@pytest.mark.asyncio
async def test_case_1_ambiguous_request_clarification(ollash_new_cases_agent):
    # Test: Orchestrator should ask for clarification for an ambiguous request
    user_request = "Something is wrong with the system."
    
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: Orchestrator tries to detect intent, gets low confidence 'exploration'
        ...
        # 4th call: Orchestrator provides clarification question based on its prompt
    ...
    response = await ollash_new_cases_agent.chat(user_request)
    assert "Your request is a bit ambiguous." in response
    assert ollash_new_cases_agent.llm_clients['default'].achat.call_count == 4


@pytest.mark.asyncio
async def test_case_2_system_info_request(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: Orchestrator detects system intent, suggests switch
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator selects system agent
    ...
    assert ollash_new_cases_agent.llm_clients['default'].achat.call_count == 6


@pytest.mark.asyncio
async def test_case_3_code_refactoring_request(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: Orchestrator detects code intent, suggests switch
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator selects code agent
...
@pytest.mark.asyncio
async def test_case_4_network_connectivity_check(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: Orchestrator detects network intent, suggests switch
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator selects network agent
...
@pytest.mark.asyncio
async def test_case_5_cybersecurity_scan_ports(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: Orchestrator detects cybersecurity intent, suggests switch
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator selects cybersecurity agent
...
@pytest.mark.asyncio
async def test_case_6_mixed_domain_request(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: Orchestrator detects ambiguous intent (or low confidence exploration)
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator asks for clarification
...
@pytest.mark.asyncio
async def test_case_7_loop_detection_clarification(ollash_new_cases_agent):
    ...
    # Override get_embedding to return identical vectors so the loop detector
    # sees cosine similarity = 1.0 and triggers the loop detection threshold.
    fixed_embedding = [1.0] * 384
    ollash_new_cases_agent.llm_clients['default'].get_embedding.side_effect = None
    ollash_new_cases_agent.llm_clients['default'].get_embedding.return_value = fixed_embedding
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: LLM will call detect_user_intent, which will return ok=True, intent='exploration'
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: LLM will call detect_user_intent again
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 5th call: LLM will call detect_user_intent a third time, triggering loop detection, which returns the dict directly
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
    ]
    ...
    # We assert that ollama.chat was called 5 times (1 preprocess + 1 classify_intent + 3 detect_user_intent)
    assert ollash_new_cases_agent.llm_clients['default'].achat.call_count == 5


@pytest.mark.asyncio
async def test_case_8_invalid_agent_type_selection(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: Orchestrator detects intent, tries to select invalid agent
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator tries to select invalid agent
        ...
        # 5th call: Orchestrator should report the error or try to re-evaluate
...
@pytest.mark.asyncio
async def test_case_9_file_read_non_existent(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call: _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call: Detect user intent
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Select code agent
...
@pytest.mark.asyncio
async def test_case_10_git_status_check(ollash_new_cases_agent):
...
@pytest.mark.asyncio
async def test_case_11_install_package(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 5th call: System agent calls install_package
        ...
        # 6th call: System agent provides installation result
...
@pytest.mark.asyncio
async def test_case_12_analyze_network_latency(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 5th call: Network agent calls analyze_network_latency
        ...
        # 6th call: Network agent provides latency results
...
@pytest.mark.asyncio
async def test_case_13_check_file_hash(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 3rd call: Detect user intent
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Select cybersecurity agent
        ...
        # 5th call: Cybersecurity agent calls check_file_hash
        ({"message": {"tool_calls": [{"function": {"name": "check_file_hash", "arguments": {"path": "document.pdf", "algorithm": "sha256"}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 6th call: Cybersecurity agent provides hash check result
...
@pytest.mark.asyncio
async def test_case_14_propose_governance_policy(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 3rd call: Detect user intent
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator calls propose_governance_policy
        ...
        # 5th call: Orchestrator provides policy proposal result
...
@pytest.mark.asyncio
async def test_case_15_detect_code_smells(ollash_new_cases_agent):
...
@pytest.mark.asyncio
async def test_case_16_monitor_resource_spikes(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 5th call: System agent calls monitor_resource_spikes
        ...
        # 6th call: System agent provides resource spike result
...
@pytest.mark.asyncio
async def test_case_17_analyze_network_latency_multi_step(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 2nd call (chat 1): _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 3rd call (chat 1): Detect user intent
        ...
        # 4th call (chat 1): Select network agent
        ...
        # 5th call (chat 1): Network agent calls analyze_network_latency
        ...
        # 6th call (chat 1): Network agent provides latency results
        ...
        # 8th call (chat 2): _classify_intent
        ({"message": {"content": "General"}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 9th call (chat 2): Detect user intent (should detect network intent again)
        ...
        # 10th call (chat 2): Agent should remain in network context and call traceroute
        ...
        # 11th call (chat 2): Agent provides traceroute results
        ({"message": {"content": "Traceroute to internal.mycompany.com completed. Hops: 3."}}, {"prompt_tokens": 10, "completion_tokens": 10}),
    ]

    response_1 = await ollash_new_cases_agent.chat(user_request_1)
    assert "Latency to internal.mycompany.com: Avg 5ms, 0% packet loss." in response_1
    assert ollash_new_cases_agent.active_agent_type == "network"
    assert ollash_new_cases_agent.llm_clients['default'].achat.call_count == 6 # After first chat call

    response_2 = await ollash_new_cases_agent.chat(user_request_2)
    ...
    assert ollash_new_cases_agent.llm_clients['default'].achat.call_count == 11 # After second chat call


@pytest.mark.asyncio
async def test_case_18_analyze_security_log(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 5th call: Cybersecurity agent calls analyze_security_log
        ({"message": {"tool_calls": [{"function": {"name": "analyze_security_log", "arguments": {"path": "auth.log", "keywords": ["FAILED LOGIN"]}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 6th call: Cybersecurity agent provides log analysis result
...
@pytest.mark.asyncio
async def test_case_19_generate_runbook(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 3rd call: Detect user intent
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator calls generate_runbook
        ...
        # 5th call: Orchestrator provides runbook generation result
...
@pytest.mark.asyncio
async def test_case_20_estimate_change_blast_radius(ollash_new_cases_agent):
    ...
    ollash_new_cases_agent.llm_clients['default'].achat.side_effect = [
        ...
        # 3rd call: Detect user intent
        ({"message": {"tool_calls": [{"function": {"name": "detect_user_intent", "arguments": {"user_request": user_request}}}]}}, {"prompt_tokens": 10, "completion_tokens": 5}),
        # 4th call: Orchestrator calls estimate_change_blast_radius
        ...
        # 5th call: Orchestrator provides blast radius estimation result
