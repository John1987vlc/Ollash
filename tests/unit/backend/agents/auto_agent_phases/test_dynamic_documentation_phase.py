...
class TestDynamicDocumentationPhase:
    ...
    def test_execute_writes_changelog(self, tmp_path):
    ...
    def test_execute_writes_roadmap_when_gaps_present(self, tmp_path):
        from backend.agents.auto_agent_phases.dynamic_documentation_phase import DynamicDocumentationPhase
    ...
    def test_execute_skips_roadmap_when_no_gaps(self, tmp_path):
        from backend.agents.auto_agent_phases.dynamic_documentation_phase import DynamicDocumentationPhase
    ...
    def test_execute_updates_readme(self, tmp_path):
        from backend.agents.auto_agent_phases.dynamic_documentation_phase import DynamicDocumentationPhase
    ...
    def test_execute_survives_changelog_error(self, tmp_path):
    ...
    def test_execute_returns_unchanged_files_on_all_errors(self, tmp_path):
        from backend.agents.auto_agent_phases.dynamic_documentation_phase import DynamicDocumentationPhase
