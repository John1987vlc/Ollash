...
from backend.utils.core.feedback.feedback_refinement_manager import FeedbackRefinementManager, ParagraphContext
from backend.utils.core.feedback.refinement_orchestrator import RefinementOrchestrator
from backend.utils.core.analysis.source_validator import SourceValidator, ValidationIssue, ValidationResult
...
class TestFeedbackRefinementManager:
    ...
    def test_select_paragraphs_by_readability(self, refinement_mgr):
        ...
        selected = refinement_mgr.select_paragraphs_for_refinement(paragraphs, {"min_readability": 30})
    ...
    def test_critique_clarity(self, refinement_mgr):
        ...
        para = ParagraphContext(index=0, text=text, original_text=text, source_id="test")
...
class TestSourceValidator:
    ...
    def test_validate_refinement_valid(self, source_validator):
        ...
        result = source_validator.validate_refinement(original, refined, "src1", "semantic")
...
class TestRefinementOrchestrator:
    ...
    def test_refine_workflow(self, orchestrator):
        ...
        results = orchestrator.refine_workflow(workflow_id="wf_refine", strategy_name="quick_polish")
...
class TestRefinementIntegration:
    ...
    def test_validation_workflow(self, orchestrator, source_validator):
        ...
        wf = orchestrator.create_workflow("validation_test", "validation_src", "Source content here with more")
