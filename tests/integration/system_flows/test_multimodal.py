...
from backend.utils.core.io.ocr_processor import OCRConfig, OCRProcessor
...
class TestMultimediaIngester:
    ...
    def test_format_detection_text(self, ingester, sample_text_file):
        ...
        from backend.utils.core.io.multimedia_ingester import DocumentType
...
class TestSpeechTranscriber:
    ...
    def transcriber(self, temp_workspace):
        ...
        from backend.utils.core.io.speech_transcriber import SpeechTranscriber, TranscriptionConfig
    ...
    def test_confidence_calculation(self, transcriber):
        ...
        from backend.utils.core.io.speech_transcriber import ConfidenceSegment
