...
class TestEpisodicMemoryEnhanced:
    ...
    @pytest.fixture
    def entry(self):
        from backend.utils.core.memory.episodic_memory import EpisodicEntry
    ...
    def test_decision_recording(self, memory):
        from backend.utils.core.memory.episodic_memory import DecisionRecord
...
class TestPromptTunerEnhanced:
    ...
    def tuner(self, tmp_path):
        from backend.utils.core.llm.prompt_tuner import FeedbackStore, PromptTuner
    ...
    def test_feedback_entry_serde(self):
        from backend.utils.core.llm.prompt_tuner import FeedbackEntry
    ...
    def test_store_save_query(self, tmp_path):
        from backend.utils.core.llm.prompt_tuner import FeedbackStore, FeedbackEntry
...
class TestSandboxes:
    def test_wasm_unavailable(self):
        from backend.utils.core.tools.wasm_sandbox import WasmSandbox
...
class TestRubricEvaluator:
    ...
    def test_json_compliance_valid_json(self):
        from backend.utils.core.llm.benchmark_rubrics import RubricDimension, RubricEvaluator
    ...
    def test_evaluate_all_dimensions(self):
        from backend.utils.core.llm.benchmark_rubrics import RubricEvaluator
    ...
    def test_multidimensional_rubric_phase_mapping(self):
        from backend.utils.core.llm.benchmark_rubrics import MultidimensionalRubric, RubricDimension
...
class TestAffinityMatrix:
    ...
    def test_build_matrix_from_benchmark_data(self, affinity_setup):
        from backend.utils.core.llm.benchmark_model_selector import AffinityMatrix, BenchmarkDatabase
...
class TestCostEfficiencyCalculator:
    ...
    def test_small_fast_model_high_efficiency(self):
        from backend.utils.core.llm.benchmark_model_selector import CostEfficiencyCalculator
    ...
    def test_rank_models_by_efficiency(self):
        ...
        from backend.utils.core.llm.benchmark_model_selector import BenchmarkDatabase, CostEfficiencyCalculator
...
class TestWeightedPhaseLoss:
    ...
    def test_critical_phase_higher_weight(self):
        from backend.utils.core.llm.benchmark_model_selector import BenchmarkDatabase
...
class TestShadowEvaluator:
    ...
    def test_stop_unsubscribes_and_persists(self, mock_publisher, tmp_path):
        from backend.utils.core.analysis.shadow_evaluator import ShadowEvaluator, ShadowLog
...
class TestPhaseFailureDatabase:
    ...
    def test_record_failure(self, tmp_path):
        from backend.utils.core.system.phase_failure_db import PhaseFailureDatabase, PhaseFailureRecord
    ...
    def test_is_model_suitable_true(self, tmp_path):
        from backend.utils.core.system.phase_failure_db import PhaseFailureDatabase
