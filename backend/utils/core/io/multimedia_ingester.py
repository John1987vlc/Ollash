...
class PlainTextParser(DocumentParser):
    ...
    def parse(self, file_path: str) -> ParsedDocument:
        ...
        lines = content.split("\n")
        blocks = [
            ContentBlock(block_id=f"block_{idx}", content=line, content_type="text")
        ...
        return ParsedDocument(
            ...
            blocks=blocks,
            raw_text=content,
            metadata={"line_count": len(lines), "file_size_bytes": path.stat().st_size},
        )
...
class MultimediaIngester:
    ...
    def _process_with_ocr(self, file_path: str, doc_id: str, doc_type: DocumentType) -> ParsedDocument:
        ...
        from backend.utils.core.io.ocr_processor import PDFOCRProcessor
    ...
    def get_ingestion_stats(self) -> Dict:
        ...
        if not self.parsed_documents:
            return {"total_ingested": 0, "by_type": {}, "total_blocks": 0}
