...
from backend.utils.domains.command_line.tool_definitions import \
    COMMAND_LINE_TOOL_DEFINITIONS
from backend.utils.domains.cybersecurity.tool_definitions import \
    CYBERSECURITY_TOOL_DEFINITIONS
from backend.utils.domains.git.tool_definitions import GIT_TOOL_DEFINITIONS
from backend.utils.domains.network.tool_definitions import \
    NETWORK_TOOL_DEFINITIONS
from backend.utils.domains.orchestration.tool_definitions import \
    ORCHESTRATION_TOOL_DEFINITIONS
from backend.utils.domains.planning.tool_definitions import \
    PLANNING_TOOL_DEFINITIONS
from backend.utils.domains.system.tool_definitions import \
