...
class PlanningTools:
    ...
    @ollash_tool(
        ...
        parameters={
            "agent_type": {
                ...
                "description": "The type of specialized agent to switch to.",
            },
            "reason": {
                "type": "string",
                "description": "Explanation for why the agent type switch is necessary.",
            },
        },
    ...
    def select_agent_type(self, agent_type: str, reason: str) -> Dict:
        ...
        if hasattr(self.agent_instance, "event_publisher") and self.agent_instance.event_publisher:
            self.agent_instance.event_publisher.publish("agent_switch", {"agent_type": agent_type, "reason": reason})
    ...
    async def request_permission_escalation(self, command: str, reason: str) -> Dict:
        ...
        confirmed = await self.agent_instance.confirmation_manager.request_confirmation(
            "permission_escalation", {"command": command, "reason": reason}
        )
    ...
    @ollash_tool(
        ...
        parameters={
            ...
            "kwargs": {
                "type": "object",
                "description": "The keyword arguments to pass to the tool.",
            },
        },
        required=["tool_name"],
        toolset_id="planning_tools",
    ...
    async def run_async_tool(self, tool_name: str, kwargs: Dict = None) -> Dict:
        ...
        if hasattr(self.agent_instance, "async_tool_executor") and self.agent_instance.async_tool_executor:
            ...
            return {
                "ok": False,
                "result": {"error": "Asynchronous tool executor not initialized."},
            }
