    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "(e.g., 'code', 'system', 'network', 'cybersecurity', 'orchestrator'). "
                "This is a meta-tool for agent self-modification."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "agent_type": {
                        "type": "string",
                        "enum": ["orchestrator", "code", "network", "system", "cybersecurity", "bonus"],
