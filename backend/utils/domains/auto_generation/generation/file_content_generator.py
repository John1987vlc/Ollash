"""Legacy file content generator.

.. deprecated::
    :class:`FileContentGenerator` is the legacy file generator. Use
...
class FileContentGenerator:
    ...
    .. deprecated::
        Use :class:`EnhancedFileContentGenerator` instead. This class will be
    ...
    def __new__(cls, *args, **kwargs):
        warnings.warn(
            "FileContentGenerator is deprecated; use EnhancedFileContentGenerator instead.",
            DeprecationWarning,
            stacklevel=2,
        )
