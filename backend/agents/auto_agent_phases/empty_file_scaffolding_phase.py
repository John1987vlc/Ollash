...
class EmptyFileScaffoldingPhase(IAgentPhase):
    ...
    def execute(
        ...
        **kwargs: Any,
        ...
        self.context.event_publisher.publish_sync("phase_start", phase="3", message="Creating empty files")
        ...
        self.context.event_publisher.publish_sync("phase_complete", phase="3", message="Empty files created")
